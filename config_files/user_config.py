...
target_python_link_path = target_python_link_path = Path("C:/Users/Polar/Documents/TMInterface/Plugins/Python_Link.as")

# Typically path(os.path.expanduser("~")) / "Documents" / "TrackMania"
trackmania_base_path = Path("C:/Users/Polar/Documents/TrackMania")
...
windows_TMLoader_path = Path("C:/Users/Polar/AppData/Local/TMLoader/TMLoader.exe")
