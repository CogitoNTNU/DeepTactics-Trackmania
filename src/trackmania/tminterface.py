"""
Simplified TMInterface client for communicating with TMInterface 2.x via sockets.
Based on linesight's implementation but simplified for single-process use.
"""
...
class TMInterface:
    ...
    def __init__(self, port: int, is_linux: bool = False):
        self.port = port
